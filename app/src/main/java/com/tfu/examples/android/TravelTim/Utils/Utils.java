package com.tfu.examples.android.TravelTim.Utils;
...
import com.tfu.examples.android.TravelTim.Activity.DetailActivity;
import com.tfu.examples.android.TravelTim.Activity.MainActivity;
...
public class Utils {
    ...
    public static void detailIntent(Context context, Object object, ImageView imageView) {
        ...
        if (object instanceof Hotel) {
            ...
            intent.putExtra(DetailActivity.INTENT_EXTRA, hotel);
        } else if (object instanceof Place) {
            Place place = (Place) object;
            intent.putExtra(DetailActivity.INTENT_EXTRA, place);
        } else if (object instanceof Shop) {
            Shop shop = (Shop) object;
            intent.putExtra(DetailActivity.INTENT_EXTRA, shop);
        } else if (object instanceof Restaurant) {
            Restaurant restaurant = (Restaurant) object;
            intent.putExtra(DetailActivity.INTENT_EXTRA, restaurant);
        }
